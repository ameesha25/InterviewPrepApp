...
const LandingPage = () => {
  ...
  const [openAuthModel, setOpenAuthMode] = useState(false);
  ...
  return (
    <>
      ...
      <div className='w-full min-h-screen bg-[#FFFCEF] relative overflow-hidden'>
        {/* Blurred background element (moved outside content area and fixed z-index) */}
        ...
        <div className='container mx-auto px-4 pt-6 pb-[200px] relative z-10'>
          ...
          <div className='flex flex-col md:flex-row items-center '>
            ...
            <div className='w-full md:w-1/2'>
              ...
              <button
                className='bg-black text-sm font-semibold text-white px-7 py-2.5 rounded-full hover:bg-yellow-200 hover:text-black border border-yellow-50 hover:border-yellow-300 transition-colors cursor-pointer'
                onClick={handleCTA}
              >
                Get Started
              </button>
      ...
      <div className='w-full min-h-full relative z-10 mb-56'>
        <div>
          <section className='flex items-center justify-center -mt-36'>
            <img src={image} alt="HERO" className='w-[80vw] rounded-lg' />
          </section>
        </div>
        <div className='w-full min-h-full bg-[#FFFCEF] mt-10 '>
          <div className='container mx-auto px-4 pt-10 pb-20'>
            <section className='mt-5'>
              <h3 className='text-2xl font-medium text-center mb-12'>Features That make you shine</h3>
        ...
        <div className='text-lg bg-gray-50 text-secondary text-center p-5 mt-5 '>Happy Learning</div>
      </div>
