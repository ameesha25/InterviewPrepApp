        ...
        <div className='bg-white rounded-lg mb-4 overflow:hidden py-4 px-5 shadow-xl shadow-gray-100/70 border border-gray-100/60'>
            <div className='flex items-start justify-between mr-5 cursor-pointer'>
                <div className='flex items-start gap-3.5'>
                    ...
                    <h3 className='text-xs md:text-[14px] font-medium text-gray-800 mr-0 md:mr-13' onClick={toggleExpand}>{question}</h3>
                </div>
                <div className='flex items-center justify-end ml-4 relative'>
                    ...
                    <button className='text-gray-400 hover:text-gray-500 cursor-pointer ml-4' onClick={toggleExpand}>
                        <LuChevronDown size={25} className={`transform transition-transform duration-300 ${
